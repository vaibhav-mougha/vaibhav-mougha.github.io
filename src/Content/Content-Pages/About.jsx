      ...
      <div className={AboutCSS.container} id="about">
        ...
        <div className={AboutCSS.aboutPage}>
            ...
            <div className={AboutCSS.content}>
                ...
                <a target={"blank"} href="https://drive.google.com/file/d/1CBMMbK5vkkORXI45WBPyabbnz6dHZtZI/view?usp=share_link"><button className={AboutCSS.cv}>Download CV</button></a>
                </div>
